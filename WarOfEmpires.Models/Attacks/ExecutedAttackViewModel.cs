...
namespace WarOfEmpires.Models.Attacks {
    ...
    public sealed class ExecutedAttackViewModel : EntityViewModel {
        ...
        [GridColumn(3, 10, "Soldiers lost", SortData = nameof(AttackerSoldierCasualties), ResponsiveDisplayBehaviour = ResponsiveDisplayBehaviour.HiddenFromLarge)]
        ...
        [GridColumn(4, 10, "Mercs lost", SortData = nameof(AttackerMercenaryCasualties), ResponsiveDisplayBehaviour = ResponsiveDisplayBehaviour.HiddenFromLarge)]
        ...
        [GridColumn(8, 10, "Mercs lost", SortData = nameof(DefenderMercenaryCasualties))]
