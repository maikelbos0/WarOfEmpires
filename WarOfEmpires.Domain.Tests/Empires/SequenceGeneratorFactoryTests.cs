...
namespace WarOfEmpires.Domain.Tests.Empires {
    ...
    public sealed class SequenceGeneratorFactoryTests {
        ...
        public void SequenceGeneratorFactory_GetValue_Works(int levelOffset, int expectedResult) {
            SequenceGeneratorFactory.GetValue(levelOffset).Should().Be(expectedResult);
        }
        ...
        public void SequenceGeneratorFactory_GetGeneratorFunction_int_Works() {
            ...
            generator(9, 9).Should().Be(120000);
        }

        [TestMethod]
        public void SequenceGeneratorFactory_GetGeneratorFunction_string_Works() {
            var generator = SequenceGeneratorFactory.GetGeneratorFunction((value) => $"This is {value * 1000}");

            generator(0, 0).Should().Be("This is 2000");
            generator(9, 9).Should().Be("This is 120000");
        }
        ...
        public void SequenceGeneratorFactory_GetGeneratorFunction_Resources_Works() {
            ...
            generator(9, 9).Should().Be(new Resources(gold: 120000, wood: 12000, stone: 6000, ore: 3000));
        }
    }
}