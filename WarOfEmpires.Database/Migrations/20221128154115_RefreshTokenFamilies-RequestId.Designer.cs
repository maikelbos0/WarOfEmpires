...
namespace WarOfEmpires.Database.Migrations
{
    ...
    [Migration("20221128154115_RefreshTokenFamilies-RequestId")]
    partial class RefreshTokenFamiliesRequestId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarOfEmpires.Database.ReferenceEntities.RaceEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarOfEmpires.Database.ReferenceEntities.ResearchTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ResearchTypes", "Empires");
            ...
            modelBuilder.Entity("WarOfEmpires.Database.ReferenceEntities.UserEventTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (byte)22,
                            Name = "Failed refresh token rotation"
                        });
                });
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Auditing.ActionExecution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ActionExecutions", "Auditing");
                });
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Empires.QueuedResearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("CompletedResearchTime")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("QueuedResearch", "Empires");
                });

            modelBuilder.Entity("WarOfEmpires.Domain.Empires.Research", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Events.ScheduledTask", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            EventType = "WarOfEmpires.Domain.Alliances.BankTurnTaskTriggeredEvent, WarOfEmpires.Domain, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null",
                            ExecutionMode = 2,
                            Interval = new TimeSpan(0, 1, 0, 0, 0),
                            IsPaused = true
                        });
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Players.Profile", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Profiles", "Players");
                });

            modelBuilder.Entity("WarOfEmpires.Domain.Security.PreviousRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PreviousRefreshTokens", "Security");
                });

            modelBuilder.Entity("WarOfEmpires.Domain.Security.RefreshTokenFamily", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RefreshTokenFamilies", "Security");
                });
                    ...
                    b.OwnsOne("WarOfEmpires.Domain.Common.Resources", "BankedResources", b1 =>
                        {
                            ...
                            b1.HasKey("AllianceId");

                            b1.ToTable("Alliances", "Alliances");
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Empires.QueuedResearch", b =>
                {
                    b.HasOne("WarOfEmpires.Domain.Players.Player", "Player")
                        .WithMany("QueuedResearch")
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WarOfEmpires.Database.ReferenceEntities.ResearchTypeEntity", null)
                        .WithMany("QueuedResearch")
                        .HasForeignKey("Type")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Players.Player", b =>
                {
                    ...
                    b.HasOne("WarOfEmpires.Database.ReferenceEntities.RaceEntity", null)
                        .WithMany("Players")
                        .HasForeignKey("Race")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Players.Profile", b =>
                {
                    b.HasOne("WarOfEmpires.Domain.Players.Player", null)
                        .WithOne("Profile")
                        .HasForeignKey("WarOfEmpires.Domain.Players.Profile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Security.PreviousRefreshToken", b =>
                {
                    b.HasOne("WarOfEmpires.Domain.Security.RefreshTokenFamily", null)
                        .WithMany("PreviousRefreshTokens")
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Security.RefreshTokenFamily", b =>
                {
                    b.HasOne("WarOfEmpires.Domain.Security.User", null)
            ...
            modelBuilder.Entity("WarOfEmpires.Domain.Security.RefreshTokenFamily", b =>
                {
                    b.Navigation("PreviousRefreshTokens");
                });
