...
namespace WarOfEmpires.Database {
    public abstract class BaseWarContext<TWarContext> : DbContext, IBaseWarContext where TWarContext : BaseWarContext<TWarContext> {
        ...
        public BaseWarContext(DbContextOptions<TWarContext> options) : base(options) { }
