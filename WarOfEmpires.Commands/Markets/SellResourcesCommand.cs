namespace WarOfEmpires.Commands.Markets {
    public sealed class SellResourcesCommand : ICommand {
        ...
        public SellResourcesCommand(string email, string food, string foodPrice, string wood, string woodPrice, string stone, string stonePrice, string ore, string orePrice) {
            Email = email;
            Food = food;
            FoodPrice = foodPrice;
            Wood = wood;
