...
namespace WarOfEmpires.CommandHandlers.Tests.Players {
    ...
    public sealed class TrainWorkersCommandHandlerTests {
        ...
        [DataTestMethod()]
        [DataRow(-1, 0, 0, 0, DisplayName = "Farmers")]
        [DataRow(0, -1, 0, 0, DisplayName = "WoodWorkers")]
        [DataRow(0, 0, -1, 0, DisplayName = "StoneMasons")]
        [DataRow(0, 0, 0, -1, DisplayName = "OreMiners")]
        ...
        [TestMethod]
        public void UntrainWorkersCommandHandler_Fails_For_Too_Little_Gold() {
            throw new System.NotImplementedException();
        }
    }
}